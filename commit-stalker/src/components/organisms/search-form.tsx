...
export const SearchForm = ({ owner, repository, page }: Props) => {
  ...
  return <form className="text-sm md:text-base w-2/4 flex py-4">
    <div className="flex items-center">
      <SearchIcon className="text-gray-700 text-base" />
      <input
        autoFocus
        name="repository" onChange={handleQueryChange} value={query} placeholder='owner/repository'
        className="bg-transparent appearance-none md:w-full py-2 px-1 text-gray-700 leading-tight focus:outline-none focus:text-blue-600" />
    </div>
    <div className="flex items-center mr-4">
      ...
      <input
        ...
        className="bg-transparent appearance-none w-20 py-2 px-1 text-gray-700 leading-tight focus:outline-none focus:text-blue-600" />
    </div>
